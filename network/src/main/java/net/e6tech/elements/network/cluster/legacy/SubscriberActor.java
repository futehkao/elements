...
class SubscriberActor extends AbstractActor {
    ...
    public AbstractActor.Receive createReceive() {
        return receiveBuilder()
                .match(MessagingEvents.Publish.class, publish -> getContext().dispatcher().execute(() -> subscriber.receive(new Notice(publish.getTopic(), (Serializable) publish.getMessage()))))
